...
# === CONFIG ===
input_csv = 'Downloads/CHF_with_pleth_mimic3_v2.csv'   # Change to 'healthy_with_pleth_mimic3.csv' for second run
output_root = 'Downloads/CHF'                       # Change to 'Downloads/healthy' for second run
